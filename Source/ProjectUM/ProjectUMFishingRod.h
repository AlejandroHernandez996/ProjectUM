...
#include "ProjectUMFishingRod.generated.h"

/**
 *
 */
UCLASS()
class PROJECTUM_API AProjectUMFishingRod : public AProjectUMWeapon, public IChannableInterface
{
	GENERATED_BODY()

public:
	AProjectUMFishingRod();
	...
	UPROPERTY(EditAnywhere, Instanced)
		class UCableComponent* FishingLine;
...
protected:
	...
	class AProjectUMFishingBaubleProjectile* SpawnedBauble;
